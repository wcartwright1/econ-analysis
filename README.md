...
3. Install jupyter for interactive notebook (conda install jupyter)
...
6. Install PyPDF2 for PDF writing (conda install PyPDF2)
7. Tkinter should be installed with basic python installation - no additional packages required
